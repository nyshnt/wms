...
@ObjectType('BomdtlIns')
@Schema({ collection: 'bomdtl_ins' })
export class BomdtlIns {
    @Field(() => ID)
    _id: Types.ObjectId;
    ...
    // Add other fields from bomdtl_ins table here...
...
export type BomdtlInsDocument = BomdtlIns & Document;
export const BomdtlInsSchema = SchemaFactory.createForClass(BomdtlIns);